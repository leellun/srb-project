...
import com.newland.srb.core.enums.LendStatusEnum;
...
import com.newland.srb.core.service.*;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements ILendItemService {
    ...
    private LendItem getByLenItemNo(String lendItemNo){
        return baseMapper.selectOne(Wrappers.<LendItem>query().eq("lend_item_no", lendItemNo));
    }
